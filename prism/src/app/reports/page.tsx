  ...
  const exportToPDF = async () => {
    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #FFFFFF;">
        ...
        <p style="color: #444444; margin-bottom: 20px;">Generated by Prism | ${dateRange}</p>
        ...
        ${summaryMetrics ? `
          <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 15px; margin-bottom: 30px;">
            ...
            <div style="border: 1px solid #E0E0E8; padding: 15px; border-radius: 8px; background-color: #FFFFFF;">
              ...
              <p style="color: #111111; font-size: 20px; font-weight: bold; margin: 5px 0;">
          ...
          <thead>
            <tr style="background-color: #2D2B55; border-bottom: 2px solid #2D2B55;">
              ${selectedReport === 'revenue' ? `
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: left; color: #FFFFFF;">Month</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Invoiced</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Collected</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Outstanding</th>
              ` : selectedReport === 'aging' ? `
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: left; color: #FFFFFF;">Client</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Current</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">1-30 Days</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">31-60 Days</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Total</th>
              ` : selectedReport === 'client' ? `
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: left; color: #FFFFFF;">Client</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Invoices</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Paid</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">% of Revenue</th>
              ` : selectedReport === 'tax' ? `
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: left; color: #FFFFFF;">Month</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Income</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Cumulative</th>
              ` : `
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: left; color: #FFFFFF;">Date</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: left; color: #FFFFFF;">Invoice</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: left; color: #FFFFFF;">Client</th>
                <th style="border: 1px solid #2D2B55; padding: 12px; text-align: right; color: #FFFFFF;">Amount</th>
              `}
            </tr>
          </thead>
          <tbody>
            ${tableData.map((row: any, idx: number) => `
              <tr style="border-bottom: 1px solid #E0E0E8; color: #111111; ${idx % 2 === 0 ? 'background-color: #F8F8FC;' : 'background-color: #FFFFFF;'}">
                ${selectedReport === 'revenue' ? `
                  <td style="border: 1px solid #E0E0E8; padding: 12px; color: #111111;">${row.month}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.invoiced.toFixed(0)}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.collected.toFixed(0)}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.outstanding.toFixed(0)}</td>
                ` : selectedReport === 'aging' ? `
                  <td style="border: 1px solid #E0E0E8; padding: 12px; color: #111111;">${row.client}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.current.toFixed(0)}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row['1-30'].toFixed(0)}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row['31-60'].toFixed(0)}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.total.toFixed(0)}</td>
                ` : selectedReport === 'client' ? `
                  <td style="border: 1px solid #E0E0E8; padding: 12px; color: #111111;">${row.client}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">${row.count}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.paid.toFixed(0)}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">${row.percentage.toFixed(1)}%</td>
                ` : selectedReport === 'tax' ? `
                  <td style="border: 1px solid #E0E0E8; padding: 12px; color: #111111;">${row.month}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.income.toFixed(0)}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.cumulative.toFixed(0)}</td>
                ` : `
                  <td style="border: 1px solid #E0E0E8; padding: 12px; color: #111111;">${row.date}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; color: #111111;">${row.invoiceNumber}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; color: #111111;">${row.client}</td>
                  <td style="border: 1px solid #E0E0E8; padding: 12px; text-align: right; color: #111111;">MYR ${row.amount.toFixed(0)}</td>
                `}
              </tr>
            `).join('')}
          </tbody>
